<?php
 function gallery_metabox_enqueue($hook) {
  ...
  function add_gallery_metabox($post_type) {
    $types = array('proyectos');
    if (in_array($post_type, $types)) {
      add_meta_box(
        'gallery-metabox',
        'Slider Proyecto (Se recomienda imagenes de tamaño 900X900)',
  ...
  function gallery_meta_callback($post) {
    ...
    <table class="form-table">
      <tr><td>
        <a class="gallery-add button" href="#" data-uploader-title="Add image(s) to gallery" data-uploader-button-text="Add image(s)">Agregar imagenes</a>
        ...
        <?php if ($ids) : foreach ($ids as $key => $value) : $image = wp_get_attachment_image_src($value); ?>
          ...
          <li class="list-inline-item">
            ...
            <a class="change-image button button-small" href="#" data-uploader-title="Change image" data-uploader-button-text="Change image">Cambiar Imagen</a><br>
            <small><a class="remove-image" href="#">Borrar Imagen</a></small>
          </li>
